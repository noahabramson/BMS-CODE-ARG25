...
def main():
    ...
    base_keys = ['AC']  # C=Cell, AC=Average Cell, FC=Filtered Cell, S=Spins
    loops = 100
    ...
    init_list = [
        ...
        {"command": "WRCFGB", "arguments": {"VUV": 1.3}},
        {"command": "WRCFGB", "arguments": {"VOV": 2.1}},
    ...
    VUV_value = results[10]['val'][device]["VUV"]

    VUV_fault = results[0]['val'][device]["C1UV"]

    VOV_fault = results[0]['val'][device]["C1OV"]

    print("fault?:" + str(VOV_fault))


    print("VUV value" + str(VUV_value))
