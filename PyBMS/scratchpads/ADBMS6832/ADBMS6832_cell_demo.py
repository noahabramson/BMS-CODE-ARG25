...
"""
This Demo measures Cell for 100 loops with Lion18 (ADBMS6832) or higher.
...
def main():
    ...
    plthelper.init()
    interface = USB_TO_SPI_BYTE('COM38', 115200, stdout=False)
    bms = BMS(interface)
    board_list = [{'Device': ADBMS6832}]

    cells = range(1,19) # Start at cell 1 and end at cell 16
    base_keys = ['C', 'S'] # C=Cell, AC=Average Cell, FC=Filtered Cell, S=Spins
    loops = 100
